...
import com.qw.kronerapp.databinding.ActivityNeverHaveIEverBinding
...
class neverHaveIEverActivity : AppCompatActivity() {
    ...
    var data = FirebaseDatabase.getInstance().getReference().child("Questions")
